...
try:
    ...
    pico5k_sources = [os.path.join('picopy', 'pico5k.pyx')]
    ...
    pico5k_sources = [os.path.join('picopy', 'pico5k.c')]
    pico_status_sources = [os.path.join('picopy', 'pico_status.c')]

include_dirs = [os.path.join('include', '5k'), numpy.get_include()]
library_dirs = []
package_data = {}
