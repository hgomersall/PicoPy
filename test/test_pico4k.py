...
class Pico4kTest(unittest.TestCase):
    ...
    def test_set_trigger_invalid_channel(self):
        ...
        trigger_object = {
                'A': dict(picopy.pico4k.default_trigger_properties),
                'logic_function': 'B',}
    ...
    def test_set_trigger_missing_property(self):
        ...
        for each_key in picopy.pico4k.default_trigger_properties:
            trigger = dict(picopy.pico4k.default_trigger_properties)
    ...
    def test_set_trigger_missing_PWQ_property(self):
        ...
        for each_key in picopy.pico4k.default_pwq_properties:
            pwq = dict(picopy.pico4k.default_pwq_properties)
